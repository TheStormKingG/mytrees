...
export const WORLD_SPECIES: LocalSpecies[] = [
  ...
  { common_name: 'Stink Toe / Locust Tree', scientific_name: 'Hymenaea courbaril',   carbon_coeff: 6.5,  native_countries: ['Guyana','Suriname','Brazil','Venezuela','Trinidad and Tobago','Jamaica','Mexico','Panama','Colombia'], family: 'Fabaceae' },
  ...
  // ── GUYANA — EXOTIC & RARE LOCAL FRUITS ──────────────────────────────
  // (local / Amerindian names used as primary common_name)
  { common_name: 'Awara Palm',                scientific_name: 'Astrocaryum vulgare',        carbon_coeff: 2.5,  native_countries: ['Guyana','Suriname','Brazil','Venezuela','Colombia','Trinidad and Tobago'],                   family: 'Arecaceae' },
  { common_name: 'Maripa / Cocorite Palm',    scientific_name: 'Attalea maripa',             carbon_coeff: 3.0,  native_countries: ['Guyana','Suriname','Brazil','Venezuela','Colombia','Trinidad and Tobago'],                   family: 'Arecaceae' },
  { common_name: 'Otaheite Gooseberry',       scientific_name: 'Phyllanthus acidus',         carbon_coeff: 0.8,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Brazil','India','Sri Lanka','Bangladesh','Myanmar','Thailand','Malaysia','Indonesia','Philippines'], family: 'Phyllanthaceae' },
  { common_name: 'Fat Poke / Satin Leaf',     scientific_name: 'Chrysophyllum oliviforme',   carbon_coeff: 2.5,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Cuba','Bahamas'],                  family: 'Sapotaceae' },
  { common_name: 'Sweet Granadilla',          scientific_name: 'Passiflora ligularis',       carbon_coeff: 0.5,  native_countries: ['Guyana','Suriname','Venezuela','Colombia','Brazil','Peru','Ecuador','Bolivia','Panama','Costa Rica','Nicaragua','Honduras','Guatemala','Mexico'],    family: 'Passifloraceae' },
  { common_name: 'Wild Passion Fruit / Somutoo', scientific_name: 'Passiflora foetida',      carbon_coeff: 0.4,  native_countries: ['Guyana','Suriname','Venezuela','Colombia','Brazil','Trinidad and Tobago','Jamaica','Dominican Republic','Panama','Mexico'],                         family: 'Passifloraceae' },
  { common_name: 'Malay Apple / Plum Rose',   scientific_name: 'Syzygium malaccense',        carbon_coeff: 2.8,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Panama','Malaysia','Indonesia','Philippines','Thailand'],    family: 'Myrtaceae' },
  { common_name: 'Rose Apple',                scientific_name: 'Syzygium jambos',            carbon_coeff: 2.0,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Panama','India','Sri Lanka','Bangladesh','Myanmar','Thailand','Malaysia','Indonesia','Philippines'], family: 'Myrtaceae' },
  { common_name: 'Venus Plum',               scientific_name: 'Chrysobalanus icaco',         carbon_coeff: 1.5,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Venezuela','Colombia','Brazil','Panama','Belize','Mexico'],                          family: 'Chrysobalanaceae' },
  { common_name: 'Biriba / Kowa',             scientific_name: 'Rollinia mucosa',            carbon_coeff: 2.5,  native_countries: ['Guyana','Suriname','Brazil','Venezuela','Colombia','Peru','Ecuador','Bolivia','Trinidad and Tobago'],                                               family: 'Annonaceae' },
  { common_name: 'Gamma Cherry / Cotton Candy Tree', scientific_name: 'Muntingia calabura',  carbon_coeff: 0.8,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Panama','Mexico','Belize','Costa Rica','Nicaragua','Honduras','Guatemala','Cuba','Brazil'], family: 'Muntingiaceae' },
  { common_name: 'Monkey Apple / Pitch Apple', scientific_name: 'Clusia grandiflora',        carbon_coeff: 3.5,  native_countries: ['Guyana','Suriname','Venezuela','Colombia','Brazil','Trinidad and Tobago'],                   family: 'Clusiaceae' },
  { common_name: 'Buru Buru',                 scientific_name: 'Mouriri guianensis',         carbon_coeff: 2.0,  native_countries: ['Guyana','Suriname','Brazil','Venezuela'],                                                    family: 'Melastomataceae' },
  { common_name: 'Barahar / Seeded Breadfruit', scientific_name: 'Artocarpus camansi',       carbon_coeff: 4.0,  native_countries: ['Guyana','Suriname','Trinidad and Tobago','Jamaica','Philippines','Indonesia','Papua New Guinea'],                                                   family: 'Moraceae' },
  ...
  { common_name: 'Jamoon / Java Plum', scientific_name: 'Syzygium cumini',          carbon_coeff: 3.2,  native_countries: ['India','Sri Lanka','Bangladesh','Nepal','Pakistan','Myanmar','Thailand','Malaysia','Indonesia','Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Panama','Colombia','Venezuela','Brazil'], family: 'Myrtaceae' },
  ...
  { common_name: 'Dungs / Dunk / Indian Jujube', scientific_name: 'Ziziphus mauritiana', carbon_coeff: 1.5, native_countries: ['India','Pakistan','Sri Lanka','Bangladesh','Nepal','Myanmar','Thailand','Kenya','Ethiopia','Nigeria','Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Brazil','Panama','Belize'], family: 'Rhamnaceae' },
  ...
  { common_name: 'Five Finger / Carambola', scientific_name: 'Averrhoa carambola',   carbon_coeff: 1.5,  native_countries: ['Malaysia','Indonesia','Philippines','Thailand','Vietnam','Laos','Cambodia','Myanmar','China','India','Sri Lanka','Guyana','Suriname','Trinidad and Tobago','Jamaica','Barbados','Dominican Republic','Haiti','Venezuela','Colombia','Brazil','Panama','Belize','Costa Rica'], family: 'Oxalidaceae' },
  ...
  { common_name: 'Dragon Fruit',       scientific_name: 'Selenicereus undatus',      carbon_coeff: 0.5,  native_countries: ['Mexico','Guatemala','Belize','Honduras','Nicaragua','Costa Rica','Colombia','Venezuela','Ecuador','Guyana','Suriname','Trinidad and Tobago','Brazil','Peru','Bolivia'], family: 'Cactaceae' },
